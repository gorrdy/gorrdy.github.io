...
<form method="POST" onsubmit="onBTCPayFormSubmit(event);return false" action="https://btcpay.sats.cz/api/v1/invoices" class="btcpay-form btcpay-form--block">
  ...
  <input type="hidden" name="browserRedirect" value="https://btcplatby.cz" />
  <input type="hidden" name="notifyEmail" value="jan.dvorak@btcplatby.cz" />
  <div class="btcpay-custom-container">
      <input class="btcpay-input-price" type="number" name="price" min="50" max="1000" step="50" value="50" data-price="50" style="width:209px;" oninput="handlePriceInput(event);return false" onchange="handleSliderChange(event);return false" />
    ...
    <input type="range" class="btcpay-input-range" min="50" max="1000" step="50" value="50" style="width:209px;margin-bottom:15px;" oninput="handleSliderInput(event);return false" />
  </div>
<button type="submit" class="submit" name="submit" style="min-width:209px;min-height:57px;border-radius:4px;border-style:none;background-color:#0f3b21;" title="Pay with BTCPay Server, a Self-Hosted Bitcoin Payment Processor"><span style="color:#fff">Podpořit</span>
<img src="https://btcplatby.cz/wp-content/uploads/2022/01/bp_logo_01.png" style="height:57px;display:inline-block;padding:5% 0 5% 5px;vertical-align:middle;">
</button></form>
<script>
    if (!window.btcpay) {
